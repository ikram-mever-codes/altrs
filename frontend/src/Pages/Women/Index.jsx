...
import product1 from "../../assets/women/women-1.png";
import product2 from "../../assets/women/women-2.png";
import product3 from "../../assets/women/women-3.png";
import product4 from "../../assets/women/women-4.png";
...
const Index = () => {
  ...
  return (
    <section className="pb-16 pt-10 alexandria lg:pb-24 w-[100vw] px-[100px] bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-12">
          <div>
            ...
            <p className="text-[16px] font-[400] text-[#6E6E6E] mt-2">
              A curated selection of versatile womenswear — designed for
              comfort, built to last, and styled to lead.
            </p>
          </div>
