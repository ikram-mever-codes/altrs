...
import product1 from "../../assets/mens/men-1.png";
import product2 from "../../assets/mens/men-2.png";
import product3 from "../../assets/mens/men-3.png";
import product4 from "../../assets/mens/men-4.png";
        ...
        <div className="flex justify-between items-center mb-12">
          <div>
            ...
            <p className="text-[16px] font-[400] text-[#6E6E6E] mt-2">
              A curated selection of versatile menswear — designed for comfort,
              built to last, and styled to lead.
            </p>
          </div>
